...
var vue_options = {
  ...
  methods: {
    do_node: function() {
      ...
      return do_post(this.base_url + '/node', params)
        .then(json => {
          this.response = json;
        })
        .catch(error => {
    ...
    do_post_json: function() {
      ...
      return do_post(this.base_url + '/post-json', params)
        .then(json => {
          this.response = json;
        })
        .catch(error => {
    ...
    do_post_urlencoded: function() {
      ...
      return do_post_urlencoded(this.base_url + '/post-urlencoded', params)
        .then(json => {
          this.response = json;
        })
        .catch(error => {
    ...
    do_post_formdata: function() {
      ...
      return do_post_formdata(this.base_url + '/post-formdata', params)
        .then(json => {
          this.response = json;
        })
        .catch(error => {
    ...
    do_get_qs: function() {
      ...
      return do_get(this.base_url + '/get-qs', qs)
        .then(json => {
          this.response = json;
        })
        .catch(error => {
